		...
		<div class="container pb-xl-5 pb-lg-3">
			<div class="row py-xl-4">
				<div class="col-lg-5 about-right-faq pr-5">
					<h6>Our  Story</h6>
					<h3 class="mt-2 mb-3">Welcome to our<b> Medcare </b></h3>
					<p>We are very happy to help people.</p>
					<p class="mt-2">Anyone can search nearest hospital by choosing district or using pincode</p>
