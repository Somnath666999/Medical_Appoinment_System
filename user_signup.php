...
<label for="nickname">Nickname: <input class="form-control" type="text" name="phonecode" id="nickname" required>
<label for="phone">Mobile Number: </label><input class="form-control" type="phone" name="phone" id="phone" maxlength="10" pattern="[0-9]{10}" required>
